...
class CharacterPagingSource @Inject constructor(private val api:RickMortyApiService) : PagingSource<Int, CharacterModel>()
{
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, CharacterModel> {
        return try {
            ...
            val nextKey = if (page > 0) page - 1 else null
            val prevKey = if (response.information.next != null) page + 1 else null
